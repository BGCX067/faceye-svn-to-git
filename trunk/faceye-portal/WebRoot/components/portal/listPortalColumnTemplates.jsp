...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<c:url value="/scripts/portal/PortalColumnTemplate.js"/>"></script>
		<link rel="stylesheet" type="text/css"
	...
	<script type="text/javascript">
Ext.onReady(com.faceye.portal.PortalColumnTemplate.init,com.faceye.portal.PortalColumnTemplate);
</script>
	<body>
