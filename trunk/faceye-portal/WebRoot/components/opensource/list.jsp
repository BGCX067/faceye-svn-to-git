...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<c:url value="/scripts/util/Components.js"/>"></script>
		<script type="text/javascript"
			src="<c:url value="/scripts/common/OpenSource.js"/>"></script>
		<script type="text/javascript"
...
.add {
	background-image:
		url(/faceye/scripts/ext/examples/shared/icons/fam/add.gif) !important;
}

.option {
	background-image:
		url(/faceye/scripts/ext/examples/shared/icons/fam/plugin.gif)
		!important;
}

.remove {
	background-image:
		url(/faceye/scripts/ext/examples/shared/icons/fam/delete.gif)
		!important;
}

.save {
	background-image:
		url(/faceye/scripts/ext/examples/shared/icons/save.gif) !important;
}
</style>
	</head>
	<script type="text/javascript">
Ext.onReady(OpenSource.init,OpenSource);
</script>
	<body>
