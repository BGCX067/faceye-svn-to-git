...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
			href="<c:url value="/scripts/ext-ui/CheckColumnTreePanel/column-tree.css"/>" />
				<link rel="stylesheet" type="text/css"
			...
			<script type="text/javascript"
			src="<c:url value="/scripts/components/security/role/Role.js"/>"></script>
			<script type="text/javascript"
			src="<c:url value="/scripts/ext-ui/CheckColumnTreePanel/CheckColumnTreePanel.js"/>"></script>
			<script type="text/javascript"
			src="<c:url value="/scripts/components/security/role/RoleVisiteModelPermission.js"/>"></script>
			<script type="text/javascript"
			src="<c:url value="/scripts/components/security/role/SelectPermissions.js"/>"></script>
		<link rel="stylesheet" type="text/css"
	...
	<script type="text/javascript">
Ext.onReady(com.faceye.compoents.core.security.Role.init,com.faceye.compoents.core.security.Role);
</script>
	<body>
		<div id="topic-grid"></div>
	    <div id="tree-viewer"></div></body>
</html>
