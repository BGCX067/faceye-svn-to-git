...
<html>
	<head>
		<title>List Compontent</title>
			...
			<script type="text/javascript"
			src="<c:url value="/scripts/components/security/resource/Resource.js"/>"></script>
	...
	<script type="text/javascript">
Ext.onReady(com.faceye.compoents.core.security.Resource.init,com.faceye.compoents.core.security.Resource);
</script>
	<body>
