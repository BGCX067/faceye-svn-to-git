...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
			...
			<script type="text/javascript"
			src="<c:url value="/scripts/components/security/permission/Permission.js"/>"></script>
			<script type="text/javascript"
			src="<c:url value="/scripts/components/security/permission/SelectResources.js"/>"></script>
	...
	<script type="text/javascript">
Ext.onReady(com.faceye.compoents.core.security.Permission.init,com.faceye.compoents.core.security.Permission);
</script>
	<body>
