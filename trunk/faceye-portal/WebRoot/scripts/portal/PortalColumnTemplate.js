            ...
            handler:function(){
            	...
            	if(!win){
                 var innerForm=new Ext.FormPanel({
                    ...
                    url:BP+'portalColumnTemplateAction.do?method=save',
                    frame:true,
                    // title: 'Simple Form',
            		...
            		win=new Ext.Window({
                        ...
                        buttons: [{
                           ...
                           innerForm.getForm().submit({
                           		...
                           		waitMsg:'正在保存数据...',
                           		//reset:BP+'portalColumnTemplateAction.do?method=generatorJSONList&entityClass=com.faceye.core.componentsupport.dao.model.DataType',
...
//                                    grid.getView().refresh();	
            		...
            		updateForm.getForm().load({
            	    	url:BP+'portalColumnTemplateAction.do?method=update&entityClass=com.faceye.components.portal.dao.model.PortalColumnTemplate&id='+id,
            	    	waitMsg:'正在加载数据，请稍后...'
            	    });
                    updateWin.show(this);
//                    loadStore.load();
...
//                    alert(loadRecord.name)
	        ...
	        //发送删除数据的请求		
            		       Ext.Ajax.request({
            			     url:BP+'portalColumnTemplateAction.do?method=remove',
            			     failure:function(){
