//version 3.0
Ext.ux.MultiselectImagePath=BP+'scripts/ext-ui/MultiselectItemSelector/';
...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
	...
	hideNavIcons:false,
	imagePath:"",
	iconUp:Ext.ux.MultiselectImagePath+"up2.gif",
	iconDown:Ext.ux.MultiselectImagePath+"down2.gif",
	iconLeft:Ext.ux.MultiselectImagePath+"left2.gif",
	iconRight:Ext.ux.MultiselectImagePath+"right2.gif",
	iconTop:Ext.ux.MultiselectImagePath+"top2.gif",
	iconBottom:Ext.ux.MultiselectImagePath+"bottom2.gif",
	drawUpIcon:true,
	drawDownIcon:true,
	drawLeftIcon:true,
	drawRightIcon:true,
    ...
    onRender: function(ct, position){
		...
		if (this.imagePath!="" && this.imagePath.charAt(this.imagePath.length-1)!="/")
			this.imagePath+="/";
		this.iconUp = this.imagePath + (this.iconUp || Ext.ux.MultiselectImagePath+'up2.gif');
		this.iconDown = this.imagePath + (this.iconDown || Ext.ux.MultiselectImagePath+'down2.gif');
		this.iconLeft = this.imagePath + (this.iconLeft || Ext.ux.MultiselectImagePath+'left2.gif');
		this.iconRight = this.imagePath + (this.iconRight || Ext.ux.MultiselectImagePath+'right2.gif');
		this.iconTop = this.imagePath + (this.iconTop || Ext.ux.MultiselectImagePath+'top2.gif');
		this.iconBottom = this.imagePath + (this.iconBottom || Ext.ux.MultiselectImagePath+'bottom2.gif');
		var el=icons.getEl();
		if (!this.toSortField) {
