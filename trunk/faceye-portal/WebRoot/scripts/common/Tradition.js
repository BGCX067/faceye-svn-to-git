...
var Tradition={
    ...
    //取得当前点击的节点ID,即取得tradition navigation 的分类
    ...
    var store = new Ext.data.Store({
        ...
        proxy: new Ext.data.HttpProxy({
            url: BP+'traditionAction.do?method=index&node='+columnId
        }),
...
//                                   	               	if(winT.findById('category-tree')){
//            				                           winT.remove('category-tree');
//            			                             }
                                   	               winT.add(tree);
                                   	               winT.show(this);
                                                })
...
//                               		},this)
                 ...
                 var innerForm=new Ext.FormPanel({
                    ...
                    url:BP+'traditionAction.do?method=save',
                    frame:true,
                    // title: 'Simple Form',
...
//                        autoScroll:true,
                        ...
                        buttons: [{
                           ...
                           innerForm.getForm().submit({
                           		method:'POST',
                           		params:{
                           			entityClass:'com.faceye.components.navigation.dao.model.Tradition'
                           		},
                           		waitMsg:'正在保存数据',
...
//                    alert(loadRecord.name)
            ...
            handler:function(){
            	...
            	if(selectedCount==0){
            		...
            		//发送删除数据的请求		
            		       Ext.Ajax.request({
            			     url:BP+'traditionAction.do?method=remove',
            			     failure:function(){
